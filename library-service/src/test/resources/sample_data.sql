...
insert into lease_requests (id, library_id, book_id, user_id, timestamp, status) values ('83484068-ef13-4198-a696-efbf510a06c2', 'library1', '1651bee3-4a18-412a-89bc-abb9dcdfe203', 'cohms1', (extract(epoch from now())*1000)::bigint, 'PENDING');
...
insert into lease_requests (id, library_id, book_id, user_id, timestamp, status) values ('7ccd1d51-61af-4602-ab76-814792da682b', 'library1', '2e611bfb-d06d-4ef9-9bf6-8d4f445ba736', 'qbloxland4', (extract(epoch from now())*1000)::bigint, 'ACCEPTED');
...
insert into lease_requests (id, library_id, book_id, user_id, timestamp, status) values ('b9d8ed6b-8bb4-43cd-a3f9-7fed8b8b1d8f', 'library1', '60dc01ad-43be-4501-aaa8-3c12741dff4f', 'qbloxland4', (extract(epoch from now())*1000)::bigint, 'ACCEPTED');
