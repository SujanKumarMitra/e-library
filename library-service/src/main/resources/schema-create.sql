...
CREATE TABLE IF NOT EXISTS authors(
	...
	CONSTRAINT fk_authors_books FOREIGN KEY(book_id) REFERENCES books(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS physical_books(
	...
	CONSTRAINT fk_physical_books_books FOREIGN KEY(book_id) REFERENCES books(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS ebooks(
	...
	CONSTRAINT fk_ebooks_books FOREIGN KEY(book_id) REFERENCES books(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS ebook_segments(
	...
	CONSTRAINT fk_ebook_segments_books FOREIGN KEY(book_id) REFERENCES ebooks(book_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS package_tags(
	...
	CONSTRAINT fk_package_tags_packages FOREIGN KEY(package_id) REFERENCES packages(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS package_items(
	...
	CONSTRAINT fk_package_items_packages FOREIGN KEY(package_id) REFERENCES packages(id) ON DELETE CASCADE,
	CONSTRAINT fk_package_items_books FOREIGN KEY(book_id) REFERENCES books(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS accepted_lease_requests(
	...
	CONSTRAINT fk_accepted_lease_requests_lease_requests FOREIGN KEY(lease_request_id) REFERENCES lease_requests(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS rejected_lease_requests(
	...
	CONSTRAINT fk_rejected_lease_requests_lease_requests FOREIGN KEY(lease_request_id) REFERENCES lease_requests(id) ON DELETE CASCADE,
